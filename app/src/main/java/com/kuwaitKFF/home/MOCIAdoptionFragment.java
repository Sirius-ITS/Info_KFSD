...
public class MOCIAdoptionFragment extends BaseActivity implements View.OnClickListener {
    ...
    public MOCIAdoptionFragment() {
        super(R.layout.fragment_moci_adoption);
    }
    ...
    public void implementation() {
        ...
        submitButton = (Button)findViewById(R.id.submitButtonMoci);
    ...
    public void callWebService() {
        ...
        if (MySharedPref.getLanguage(MOCIAdoptionFragment.this).equalsIgnoreCase(MyCommon.LANGUAGE_ENG))
        ...
        MyHttpConnection.get(MyCommon.WS_METHOD_MOCI, params,
    ...
    AsyncHttpResponseHandler asyncLoginResponseHandler = new AsyncHttpResponseHandler() {
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            try{
                ...
                JSONObject jsonObject = json.getJSONObject("KfsdMociResponse");
//                Log.d("MzTag",jsonObject.toString());
                ...
                {
                    Intent intent = new Intent(getBaseContext(), MOCIError.class);
                    intent.putExtra("appNo", trxNoEditTxt.getText().toString());
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.submitButtonMoci) {
