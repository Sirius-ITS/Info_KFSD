...
public class CircularDetailsFragment extends BaseActivity   {
	...
	boolean comingFromCorrespondance = false;
	
	public CircularDetailsFragment() {
	...
	public void implementation() {
		...
		String docFlag=b.getString("docFlag");

		if(docFlag != null)
			comingFromCorrespondance = true;
		else
			setHeader(getResources().getString(R.string.circular), true, true);
